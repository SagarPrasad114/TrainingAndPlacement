  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center'>
        ...
        {/* Eligibility */}
        <div className='flex flex-col my-[2.5rem] border-[2px] border-black  border-solid mx-[20px]'>
        ...
        {/*Rules*/}
        <div className='flex flex-col my-[2.5rem] border-[2px] border-black border-solid mx-[20px]'>
          <div className='flex justify-center items-center border-black mt-[15px] mb-[30px] text-3xl font-bold '>
        ...
        {/*Offers Criteria*/}
        <div className='flex flex-col my-[2.5rem] border-[2px] border-black border-solid mx-[20px]'>
          <div className='flex justify-center items-center mt-[15px] mb-[20px] text-3xl font-bold '>
            <h1>Job Offers</h1>
          </div>
          <div className='p-[50px] text-[21px]'>
            ...
            <div className='flex flex-row'>
              ...
              <div>
                <h2>
                 Students are eligible for 1 job offer in any 3 of the ranges that are :
                </h2>
                <ul>
                <li>
                  1-7 LPA:
